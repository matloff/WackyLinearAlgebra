...
where 'ACov' means the asymptotic covariance matrix of $(Q,R)$.
...
As to $ACov(v,w)$ in @eq-deltaquad, we would use the multivariate analog
of the usual univariate $S^2$, taking advantage of
@eq-matrixdef. One must be careful, though, making sure we choose the
appropriate quantity for $ACov(v,w)$.
