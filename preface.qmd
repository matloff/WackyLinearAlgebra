...
Earlier in this Preface, we said, "If a Data Science or Statistics
program requires linear algebra offered by a Math Department, the level
and content of this book should be similar to that math course..."
So, the mathematical content is definitely here, but one might also say,
this book is "mathematical but not very theoretical."

Theorems are mainly limited to results with practical importance, and
proofs are sometimes rather informal. Among the Your Turn exercises at
the end of each chapter, the ones requiring proofs are usually simple,
of the "one liner" type.  But the subject matter is indeed mathematical.
...
*The applied nature of the book is a double-edged sword.* Understanding
applications is actually *more* challenging than a purely mathematical
treatment, not less so. Math is more crisply-defined, while applications
can be "fuzzy"; among the Your Turn exercises, many of the applied ones
are somewhat open-ended.  Hence the need for (a) developing student
intuition and (b) nonpassive learning are paramount.
