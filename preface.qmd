...
central role of matrices and vector spaces in Data Science." A title
more typical of "math support for field X" books might be "Linear
Algebra for Data Science," but the goal in the title is to emphasize the
fact that:
...
Thus the many R examples are meant to make the mathematical
concepts concrete. This is definitely not an "how to do linear algebra
in R" book. The famous physicist Richard Feynman once said, "I learned
very early the difference between knowing the name of something and
knowing something," i.e. knowing the name without understanding is
useless. In the software context, the statement should be, "Knowing how
to use code libraries for something is useless if one doesn't understand
