...
* Calculus, e.g. derivatives as rates of change and slopes of tangent lines.  

* Basics of random variables, e.g. density functiopns,
...
Currently 1.0.1. Correction of typos etc. will usually increment the
third digit.
