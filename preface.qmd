...
important to understand why the title is NOT
"Linear Algebra for Data Scientists." That latter would connote that
people in Data Science will first learn linear algebra purely as a
branch of math in this book, then apply that knowledge in subsequent
Data Science courses. Instead, the goal in the title is to emphasize the
fact that:
...
> Almost every concept in this book is first motivated by a Data Science
> application.
