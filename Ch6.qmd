...
sure the latter file is in the same directory/folder as the one from
which you are running Quarto.
...
predictors. There is an old rule of thumb that one should have $p <
\sqrt{n}$ to avoid overfitting, which in our setting of $n = 1157$
