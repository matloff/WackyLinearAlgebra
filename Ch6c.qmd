...
## SVD: the Data Scientist's Swiss Army Knife
...
We will omit the formal definition of pseudoinverses and their
properties, returning to the topic in @sec-chapDD.  For now, we state
without proof that:
...
## Dimension Reduction: SVD as the Best Low-Rank Approximation
