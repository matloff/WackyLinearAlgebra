...
measurements. The goal is to predict the year from the audio variables.
...
that such an estimator has low variance. 

Thus it is at least plausible that we might get a second U-shape, as the
impact of the minimum-norm nature of SVD kicks in.
