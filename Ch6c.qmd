...
$$
(AA') ( \frac{1}{\sigma_i} Av_i) = 
A[A'A ~ \frac{1}{\sigma_i} v_i] =
A[\frac{1}{\sigma_i} v_i] =
u_i
$$
...
* Achieve a further reduction in storage requirements. for instance in
  settings in which we have many, many images or even better,
  many, many videos.
...
\times m$, for $u$ users and $m$ movies. Recalling that $V$ is made up 
