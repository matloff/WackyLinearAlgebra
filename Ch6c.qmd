...
* Consider the column space first. From @eq-aissumuiv write
  ...
  Now keep in mind, ultimately our focus here is on $x$, not $Ax$.
  Thus the question at hand is,

  <blockquote>

  Which values of $x$ will make $Ax \neq 0$?
  ...
  For which values of $x$ will we have $v_i'x \neq 0$ for at least one
  $i$ in $1,...,r$?

  </blockquote>

  ask, is *any* linear combination of $v_1,...v_r$, say $c_1
