...
(MSE)
as 0.2474. (Coincidentally, it was also the smallest value that the
function tried; see **glmOut$lambda**.) A more conservative value of
...
problem is that we must still choose $\lambda$. This is typically done
via cross-validation.

## Ridge vs. LASSO for Prediction
