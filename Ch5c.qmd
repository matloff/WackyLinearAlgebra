...
In seminal paper, Hoerl and Kennard[*Technometrics*,
...
context here, if we look at many values of $\lambda$, of them may by
accident look very promising, e.g. result in very good prediction
accuracy yet actually overfit.
...
* The concentric ellipses depict the values of $c(b) = (S - Ab)'(S -
  ...
  * By the way, the common center of these ellipses is the OLS solution
    $b_{OLS}$, and the smallest ellipse has c(b) equal to the
    OLS sum of squares.
