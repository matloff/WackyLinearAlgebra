...
* The same argument applies to ridge, where we have a circle rather than
  a diamond. The major difference, though, is that with the LASSO, the
  solution will almost certainly be one of the corners of the diamond,
  each of which sets some $b_i$ to 0.
