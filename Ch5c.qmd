...
An advantage of ridge over LASSO is that the former has an explicit (we
day *closed-form*) solution, which is not the case for the LASSO. In
fact, many algorithms in statistics/machine learning lack closed-form
