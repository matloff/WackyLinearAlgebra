...
## The Kernel Trick and Kernel Ridge Regression
...
[N. Matloff, $\textit{The Art of Machine Learning}$, NSP, 2023]{.column-margin},
...
Here $k$ is a \textit{kernel function} satisfying

* $k$ is a symmetric function in its arguments, and 

* $k$ is $\textit{nonnegative definite}$.
...
We say that $\phi$ *lifts* us from our *ambient* (i.e. original space,
dimension $p$) to a desired higher-dimensional space.
