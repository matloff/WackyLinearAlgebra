...
This we can determine the rank of $B$ by counting the nonzero rows of
its RREF.
...
forming $B_{rre}$? Each step will change one or two of the $r_i$. Will
we be able to ensure that their new versions wlll still be linearly
independent?
