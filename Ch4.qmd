...
columns of $A$ was equal to the first column. We say the rows or columns
are *linearly dependent*. This is the culprit in non-full rank matrices.
...
For any rxs matix $G$, the rank of $G$ is less than or equal to 
$\min(r,s)$.
