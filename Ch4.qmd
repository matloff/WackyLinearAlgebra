...
### Yes, one can tell the rank of a matrix by looking at its
RREF{#sec-yessamerank}
...
*Proof:* Say $A$ has rank $r$. Then there exist $r$ linearly independent
...
$WA$ are $Wc_1,...,Wc_r$ (from @sec-partitioned).
...
The above theorem says that pre- or postmultiplying $A$ will not 
