...
For any of the three elementary operations, a slightly modified linear
combination works (i.e. will be nonzero) with the modified matrix:
...
least that of $A$. On the other hand, apply our knowlege of
partitioning:

* Each row of $A'A$ is a linear combination of the rows of $A'$. 

* So a linear combination of the rows of $A'A$ is a linear combination
  of linear combinations of rows of $A$ -- still a linear combination of
  the rows of $A$! At most $s$ members of that linear combination are
