...
on $\Omega$ having finite variance.  (i.e. finite second moment).
...
Note: In these problems, assume that $\cal RV(\Omega)$ is restricted to
random variables of finite variance.
