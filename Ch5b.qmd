...
take covariance as our inner product:
...
Recall that correlation is the quotient of covariance and the product of
standard deviations. Thus random variables $U$ and $V$ are uncorrelated
if and only if they are orthogonal in $\cal RV(\Omega)$.
...
### Projections in $\cal RV(\Omega)$: how they work{#sec-howtheywork}
