...
can easily obtain it by calculating $<x,u_i>$.

But how do we obtain an orthogonal basis, if we only have a
nonorthogonal one? That's next...
...
the vector by its length.  Here is the process for conversion:
