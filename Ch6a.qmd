...
A matrix times a vector equals a constant times that same vector. That
opens a huge world. We will return to the notion of principal components
in the next chapter, after laying the groundwork in the current chapter.
