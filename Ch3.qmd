...
[Actually, the -1 term in our R code above is meant to allude to "minus,
i.e. removing, the $\beta_0$ term."]{.column-margin} Note the column of
1s, needed to pick up the $\beta_0$ term.
