...
* Rather than predicting a numerical quantity, these applications are
  usually of the *classification* type, in which we guess which class
  our data belong to. (Often the number of classes is huge.) As such,
  the elements of $V$ will the conditional probabilities of the various
  classes, given the contents of $Q$.

The fundamental cmputations consist of dot products of rows of $Q$ and
$K$.
...
the linear regression model in @sec-leastsquaresintro,
