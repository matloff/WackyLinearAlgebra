...
variables vary together. Say for instance $V$ is usually large -- meaning
above its mean $EV$ -- when $U$ is large (i.e.\ above \textit{its}
...
Note a couple of properties of covariance:
