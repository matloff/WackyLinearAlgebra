...
vector $(v_1,v_2,...,v_n)'$.  If $M$ is of size $m \times n$, then
$v$ is $n \times 1$.
...
looks, once again symbolically like the product of $1 \times n$
and $n \times 1$ vectors, resulting in a $1 \times 1$, i.e. a
number.
