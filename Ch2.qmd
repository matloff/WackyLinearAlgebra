...
❄️  **Your Turn:** Prove these assertions.  Note that for the identity
matrix $I$, $I' = I$.
...
The standard definition is one of the ugliest, in all
of mathematics. It involves sums and differences of permuted products of
distinct elements of the matrix.

Instead we will define the term using one of the methods
...
It can be shown that if a random vector is MV normally distributed, then
the conditional distribution of any one of its componentx $Y$, given the
