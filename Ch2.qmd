...
* Roughly speaking, the term *standard error* of is our estimate of
  $\sqrt{\widehat{\theta}}$.  More precisely, suppose that
  $\widehat{\theta}$ is asymptotically normal.  The standard error is an
  estimate of the standard deviation of that normal distribution.
...
f_1^2 (Q,R) Var(Q) +
f_2^2 (Q,R) Var(R) +
2 f_1(Q,R) f_2(Q,R) Cov(Q,R)
}
$$

where again quantities like $Var(Q)$ are understood to be in the context
